...
struct global_state_t { /* COMMON_PORTABLE */
  ...
  /**
   * * @brief UNDOCUMENTED: Options for pinning workers to hardware
     * threads in runtime.
     */
  ...
  /**
    * @brief UNDOCUMENTED: System cpu map, which describes the layout
    * of current machine.
    */

  system_cpu_map* pin_map;

  /**
    * @brief UNDOCUMENTED
    *
    * Flag specifying whether we should use TSX extensions within the
    * runtime or not.
    */
