...
typedef struct private_struct {
	...
	//==============================================================
	//	SELECTION, SELECTION 2, SUBTRACTION, DIFFERENTIAL LOCAL SUM, 
	//	    DENOMINATOR A, DENOMINATOR, CORRELATION
	//==============================================================
	...
	int* par_max_coo;
        ...
        // ANGE: added variables to carry their values across steps
        fp in_final_sum;
        fp denomT;
} private_struct;
