...
/// A "normal" __cilkrts_stack_frame.
#define CILK_DEFAULT_TYPE_SF 0

/// The outer "control" frame of a pipe_while loop.
#define CILK_PIPE_CONTROL_SF 1

/// The frame for an iteration of a pipe_while.
#define CILK_PIPE_ITER_SF    2
...
#define CILK_FRAME_PIPER     0x20000
